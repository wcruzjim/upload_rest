...
|
*/
$config['rest_valid_logins'] = ['admin' => 'NXPvbP2e3QezJs7c'];
...
|
*/
$config['rest_logs_table'] = 'teo_service_logs';
...
|
*/
$config['rest_language'] = EnvLoader::getEnv('LANG') !== null ? EnvLoader::getEnv('LANG') : 'spanish';
...
|
*/
$config['check_cors'] = EnvLoader::getEnv('SECURITY_CORS_ENABLED') !== null ? filter_var(EnvLoader::getEnv('SECURITY_CORS_ENABLED'), FILTER_VALIDATE_BOOLEAN) : FALSE;
/*
|--------------------------------------------------------------------------
...
|
*/
$config['allow_any_cors_domain'] = EnvLoader::getEnv('SECURITY_CORS_ENABLED') !== null  ? !filter_var(EnvLoader::getEnv('SECURITY_CORS_ENABLED'), FILTER_VALIDATE_BOOLEAN) : TRUE;
/*
|--------------------------------------------------------------------------
...
|
*/
$config['allowed_cors_origins'] = ( EnvLoader::getEnv('SECURITY_CORS_ENABLED') === "TRUE" && EnvLoader::getEnv('SECURITY_CORS_WHITE_LIST') !== null )  ? explode(",",EnvLoader::getEnv('SECURITY_CORS_WHITE_LIST')) : [];
/*
|--------------------------------------------------------------------------
| CORS Forced Headers
|--------------------------------------------------------------------------
